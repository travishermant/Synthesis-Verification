...
module sync_counter ( fast_clk, data, multiply );
  ...
  DFFX1_RVT \count_reg[0]  ( .D(n16), .CLK(fast_clk), .QN(n16) );
  DFFX1_RVT \count_reg[1]  ( .D(N1), .CLK(fast_clk), .Q(\count[1] ) );
  DFFX1_RVT \decode_reg[3]  ( .D(comb1[3]), .CLK(n15), .QN(n5) );
  DFFX1_RVT \decode_reg[2]  ( .D(comb1[2]), .CLK(n20), .Q(\decode[2] ) );
  DFFX1_RVT \decode_reg[1]  ( .D(comb1[1]), .CLK(n20), .Q(n17), .QN(n6) );
  DFFX1_RVT \decode_reg[0]  ( .D(comb1[0]), .CLK(n20), .Q(n18), .QN(n4) );
  DFFX1_RVT \multiply_reg[3]  ( .D(comb2[3]), .CLK(n15), .Q(multiply[3]) );
  DFFX1_RVT \multiply_reg[2]  ( .D(comb2[2]), .CLK(n20), .Q(multiply[2]) );
  DFFX1_RVT \multiply_reg[1]  ( .D(comb2[1]), .CLK(n20), .Q(multiply[1]) );
  DFFX1_RVT \multiply_reg[0]  ( .D(comb2[0]), .CLK(n20), .Q(multiply[0]) );
  ...
  AO22X1_RVT U3 ( .A1(synch[3]), .A2(n1), .A3(n9), .A4(n19), .Y(n13) );
  AO22X1_RVT U4 ( .A1(synch[2]), .A2(n1), .A3(n8), .A4(n19), .Y(n12) );
  AO22X1_RVT U5 ( .A1(synch[1]), .A2(n1), .A3(n7), .A4(n2), .Y(n11) );
  AO22X1_RVT U6 ( .A1(synch[0]), .A2(n1), .A3(n10), .A4(n2), .Y(n14) );
  INVX0_RVT U7 ( .A(n1), .Y(n2) );
  OR2X1_RVT U8 ( .A1(n15), .A2(n16), .Y(n1) );
  ...
  XNOR2X1_RVT U19 ( .A1(\count[1] ), .A2(n16), .Y(N1) );
  NBUFFX2_RVT U20 ( .A(n2), .Y(n19) );
  INVX1_RVT U21 ( .A(\count[1] ), .Y(n20) );
  INVX1_RVT U22 ( .A(\count[1] ), .Y(n15) );
  AND2X1_RVT U23 ( .A1(n17), .A2(n18), .Y(comb2[0]) );
  NAND2X0_RVT U24 ( .A1(n4), .A2(n6), .Y(comb2[1]) );
  AND2X1_RVT U25 ( .A1(\decode[2] ), .A2(n17), .Y(comb2[2]) );
  NAND2X0_RVT U26 ( .A1(n5), .A2(n6), .Y(comb2[3]) );
endmodule
